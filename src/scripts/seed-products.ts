...
function inferCategoryHandles(title: string): string[] {
  ...
  if ((t.includes('mask') || t.includes('face pack') || t.includes(' pad ') || t.endsWith('pad') || /\bpads?\b/.test(t)) && !t.includes('eye pad')) cats.push('face-mask')
...
const PRODUCTS: ProductSeedData[] = [
  ...
  // ── ANUA (additional) ───────────────────────────────────────────────────
  {
    title: "ANUA Rice Enzyme Brightening Cleansing Powder 40g",
    handle: "rice-enzyme-brightening-cleansing-powder-40-g",
    subtitle: "40g",
    brand_handle: "anua",
    origin_country: "KR",
    price_bdt: 2100,
  ...
  {
    title: "ANUA Niacinamide 5 TXA Brightening Pad",
    handle: "niacinamide-5-txa-brightening-pad",
    subtitle: "60 Pads",
    brand_handle: "anua",
    origin_country: "KR",
    price_bdt: 2500,
  },
  {
    ...
    handle: "bha-2-gentle-exfoliating-toner",
    subtitle: "150ml",
    brand_handle: "anua",
    origin_country: "KR",
    price_bdt: 2000,
  ...
  {
    title: "ANUA Heartleaf Spot Pad Calming Touch 150ml (80 Pads)",
    handle: "heartleaf-spot-pad-calming-touch-150ml-5-07-fl-oz-80-pads",
    subtitle: "80 Pads",
    brand_handle: "anua",
    origin_country: "KR",
    price_bdt: 1800,
  ...
  // ── AXIS-Y (additional) ─────────────────────────────────────────────────
  {
    ...
    handle: "axis-y-dark-spot-correcting-glow-serum-50ml",
    subtitle: "50ml",
    brand_handle: "axis-y",
    origin_country: "KR",
    price_bdt: 1150,
  ...
  // ── COSRX (additional) ──────────────────────────────────────────────────
  {
    title: "COSRX The Vitamin C 23 Serum 20ml",
    handle: "cosrx-the-vitamin-c-23-serum-20ml",
    subtitle: "20ml",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 1800,
  ...
  // ── SKIN1004 (additional) ───────────────────────────────────────────────
  {
    title: "SKIN1004 Madagascar Centella Tone Brightening Cleansing Gel Foam 125g",
    handle: "madagascar-centella-tone-brightening-cleansing-gel-foam-125g",
    subtitle: "125g",
    brand_handle: "skin1004",
    origin_country: "KR",
    price_bdt: 1200,
  ...
  {
    title: "SKIN1004 Madagascar Centella Tone Brightening Boosting Toner 210ml",
    handle: "madagascar-centella-tone-brightening-boosting-toner-210ml",
    subtitle: "210ml",
    brand_handle: "skin1004",
    origin_country: "KR",
    price_bdt: 1800,
  },
  {
    ...
    handle: "madagascar-centella-toning-toner-210ml",
    subtitle: "210ml",
    brand_handle: "skin1004",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  // ── HEIMISH (additional) ────────────────────────────────────────────────
  {
    title: "HEIMISH Moringa Ceramide BB Cream SPF30",
    handle: "heimish-moringa-ceramide-bb-cream-spf30",
    subtitle: "30g",
    brand_handle: "heimish",
    origin_country: "KR",
    price_bdt: 1600,
  ...
  {
    title: "HEIMISH RX Retinol Bakuchiol Eye Cream 30ml",
    handle: "heimish-rx-retinol-bakuchiol-eye-cream-30ml",
    subtitle: "30ml",
    brand_handle: "heimish",
    origin_country: "KR",
    price_bdt: 2100,
  },
  // ── AROMATICA (additional) ──────────────────────────────────────────────
  {
    title: "AROMATICA Rosemary Scalp Scaling Shampoo 400ml",
    handle: "aromatica-rosemary-scalp-scaling-shampoo-400-ml",
    subtitle: "400ml",
    brand_handle: "aromatica",
    origin_country: "KR",
    price_bdt: 2300,
  ...
  {
    title: "AROMATICA Rosemary Scalp Scaling Shampoo 180ml",
    handle: "aromatica-rosemary-scalp-scaling-shampoo-180-ml",
    subtitle: "180ml",
    brand_handle: "aromatica",
    origin_country: "KR",
    price_bdt: 1600,
  },
  // ── EQUALBERRY (additional) ─────────────────────────────────────────────
  {
    title: "Equalberry Purple PDRN Pore Minimizing Serum 30ml",
    handle: "eqqualberry-purple-pdrn-pore-minimizing-serum-30-ml",
    subtitle: "30ml",
    brand_handle: "equalberry",
    origin_country: "KR",
    price_bdt: 2000,
  ...
  {
    title: "Equalberry Purple Rice Pore Purifying Pack Cleanser 150g",
    handle: "eqqualberry-purple-rice-pore-purifying-pack-cleanser-150",
    subtitle: "150g",
    brand_handle: "equalberry",
    origin_country: "KR",
    price_bdt: 1800,
  ...
  // ── MEDICUBE (additional) ───────────────────────────────────────────────
  {
    title: "Medicube PDRN Pink Cica Soothing Toner 250ml",
    handle: "medicube-pdrn-pink-cica-soothing-toner-250-ml",
    subtitle: "250ml",
    brand_handle: "medicube",
    origin_country: "KR",
    price_bdt: 2200,
  ...
  // ── THE ORDINARY ────────────────────────────────────────────────────────
  {
    title: "The Ordinary Glycolic Acid 7% Exfoliating Toner 240ml",
    handle: "the-ordinary-glycolic-acid-7-exfoliating-toner-240-ml",
    subtitle: "240ml",
    brand_handle: "the-ordinary",
    origin_country: "CA",
    price_bdt: 2800,
  },
  {
    title: "The Ordinary Glycolic Acid 7% Exfoliating Toner 100ml",
    handle: "the-ordinary-glycolic-acid-7-exfoliating-toner-100-ml",
    subtitle: "100ml",
    brand_handle: "the-ordinary",
    origin_country: "CA",
    price_bdt: 2100,
  },
  {
    ...
    handle: "the-ordinary-niacinamide-10-zinc-1-30ml",
    subtitle: "30ml",
    brand_handle: "the-ordinary",
    origin_country: "CA",
    price_bdt: 1500,
  ...
  {
    title: "The Ordinary Multi-Peptide Serum for Hair Density 60ml",
    handle: "the-ordinary-multi-peptide-serum-for-hair-density-60ml",
    subtitle: "60ml",
    brand_handle: "the-ordinary",
    origin_country: "CA",
    price_bdt: 3800,
  ...
  // ── THE FACE SHOP ───────────────────────────────────────────────────────
  {
    title: "THE FACE SHOP Rice Water Bright Cleansing Foam 150ml",
    handle: "thefaceshop-rice-water-bright-cleansing-foam-150ml",
    subtitle: "150ml",
    brand_handle: "the-face-shop",
    origin_country: "KR",
    price_bdt: 1200,
  },
  {
    title: "THE FACE SHOP Rice Ceramide Moisturizing Cream 50ml",
    handle: "thefaceshop-rice-ceramide-moisturizing-cream-50ml",
    subtitle: "50ml",
    brand_handle: "the-face-shop",
    origin_country: "KR",
    price_bdt: 1300,
  ...
  },
  {
    ...
    handle: "thefaceshop-rice-water-bright-light-cleansing-oil-150ml",
    subtitle: "150ml",
    brand_handle: "the-face-shop",
    origin_country: "KR",
    price_bdt: 1200,
  },
  {
    ...
    handle: "thefaceshop-rice-water-bright-rich-cleansing-oil-150ml",
    subtitle: "150ml",
    brand_handle: "the-face-shop",
    origin_country: "KR",
    price_bdt: 1200,
  ...
  // ── DR. CEURACLE ────────────────────────────────────────────────────────
  {
    title: "DR. CEURACLE Vegan Kombucha Tea Gel Cream 75g",
    handle: "dr-ceuracle-vegan-kombucha-tea-gel-cream-75g",
    subtitle: "75g",
    brand_handle: "dr-ceuracle",
    origin_country: "KR",
    price_bdt: 2400,
  },
  {
    title: "DR. CEURACLE Vegan Kombucha Tea Essence 150ml",
    handle: "dr-ceuracle-vegan-kombucha-tea-essence-150ml",
    subtitle: "150ml",
    brand_handle: "dr-ceuracle",
    origin_country: "KR",
    price_bdt: 2700,
  ...
  {
    title: "DR. CEURACLE Scalp DX Scaling Shampoo 500ml",
    handle: "dr-ceuracle-scalp-dx-scaling-shampoo-500ml",
    subtitle: "500ml",
    brand_handle: "dr-ceuracle",
    origin_country: "KR",
    price_bdt: 2700,
  ...
  {
    title: "DR. CEURACLE Royal Vita Propolis 33 Cream 50ml",
    handle: "dr-ceuracle-royal-vita-propolis-33-cream-50ml",
    subtitle: "50ml",
    brand_handle: "dr-ceuracle",
    origin_country: "KR",
    price_bdt: 2500,
  ...
  // ── LANEIGE ─────────────────────────────────────────────────────────────
  {
    ...
    handle: "laneige-lip-sleeping-mask-berry-20g",
    subtitle: "20g",
    brand_handle: "laneige",
    origin_country: "KR",
    price_bdt: 1800,
  },
  {
    title: "LANEIGE Lip Sleeping Mask Berry 3g",
    handle: "laneige-lip-sleeping-mask-berry-3g",
    subtitle: "3g",
    brand_handle: "laneige",
    origin_country: "KR",
    price_bdt: 400,
  ...
  {
    title: "LANEIGE Water Sleeping Mask 70g",
    handle: "laneige-water-sleeping-mask-70-g",
    subtitle: "70g",
    brand_handle: "laneige",
    origin_country: "KR",
    price_bdt: 2500,
  ...
  // ── MIZON ───────────────────────────────────────────────────────────────
  {
    title: "MIZON All In One Snail Repair Cream 75ml",
    handle: "mizon-all-in-one-snail-repair-cream-75-ml",
    subtitle: "75ml",
    brand_handle: "mizon",
    origin_country: "KR",
    price_bdt: 2200,
  ...
  {
    title: "MIZON Black Snail All In One Cream 75ml",
    handle: "mizon-black-snail-all-in-one-cream-75ml",
    subtitle: "75ml",
    brand_handle: "mizon",
    origin_country: "KR",
    price_bdt: 2100,
  ...
  {
    title: "MIZON Snail Repair Eye Cream 25ml",
    handle: "mizon-snail-repair-eye-cream-25ml",
    subtitle: "25ml",
    brand_handle: "mizon",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  // ── NATURE REPUBLIC ─────────────────────────────────────────────────────
  {
    title: "NATURE REPUBLIC Argan Essential Deep Care Conditioner 300ml",
    handle: "nature-republic-argan-essential-deep-care-conditioner-300ml",
    subtitle: "300ml",
    brand_handle: "nature-republic",
    origin_country: "KR",
    price_bdt: 2000,
  },
  {
    title: "NATURE REPUBLIC Argan Essential Deep Care Shampoo 300ml",
    handle: "nature-republic-argan-essential-deep-care-shampoo-300ml",
    subtitle: "300ml",
    brand_handle: "nature-republic",
    origin_country: "KR",
    price_bdt: 2000,
  ...
  {
    title: "NATURE REPUBLIC Argan Essential Deep Care Hair Pack 200ml",
    handle: "nature-republic-argan-essential-deep-care-hair-pack-200ml",
    subtitle: "200ml",
    brand_handle: "nature-republic",
    origin_country: "KR",
    price_bdt: 1500,
  ...
  // ── TOCOBO ──────────────────────────────────────────────────────────────
  {
    title: "TOCOBO Cotton Soft Sun Stick SPF50+ PA++++ 19g",
    handle: "tocobo-cotton-soft-sun-stick-spf50-pa-19g-product-in-stock",
    subtitle: "19g",
    brand_handle: "tocobo",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  {
    title: "TOCOBO Collagen Brightening Eye Gel Cream 30ml",
    handle: "tocobo-collagen-brightening-eye-gel-cream-30ml",
    subtitle: "30ml",
    brand_handle: "tocobo",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  // ── TIAM ────────────────────────────────────────────────────────────────
  {
    title: "TIAM Vita B3 Source 40ml",
    handle: "tiam-vita-b3-source-40ml",
    subtitle: "40ml",
    brand_handle: "tiam",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  // ── ACWELL ──────────────────────────────────────────────────────────────
  {
    title: "ACWELL Licorice pH Balancing Cleansing Toner 5.5 150ml",
    handle: "acwell-licorice-ph-balancing-cleansing-toner-5-5-150ml",
    subtitle: "150ml",
    brand_handle: "acwell",
    origin_country: "KR",
    price_bdt: 1500,
  ...
  // ── DR. JART+ ───────────────────────────────────────────────────────────
  {
    title: "DR.JART+ Skin Barrier Moisturizing Cream 50ml",
    handle: "dr-jart-skin-barrier-moisturizing-cream-50ml",
    subtitle: "50ml",
    brand_handle: "dr-jart",
    origin_country: "KR",
    price_bdt: 3000,
  },
  // ── ABIB ────────────────────────────────────────────────────────────────
  {
    title: "ABIB Quick Sunstick Protection Bar 22g",
    handle: "quick-sunstick-protection-bar-22g",
    subtitle: "22g",
    brand_handle: "abib",
    origin_country: "KR",
    price_bdt: 1700,
  },
  // ── PRITHIBEE (baby care, soaps & additional skincare) ──────────────────
  // ── DABO ──
  {
    title: "Dabo Whitening & Shining Rice Ferment Foam Face Wash (180ml)",
    handle: "dabo-whitening-and-shining-rice-ferment-foam-face-wash-180ml",
    subtitle: "180ml",
    brand_handle: "dabo",
    origin_country: "KR",
    price_bdt: 1450,
  ...
  {
    title: "Dabo Collagen Lifting Sun Cream SPF50+ PA+++ (70ml)",
    handle: "dabo-collagen-lifting-sun-cream-spf50-pa-70ml",
    subtitle: "70ml",
    brand_handle: "dabo",
    origin_country: "KR",
    price_bdt: 800,
  ...
  {
    title: "DABO All in One Black Snail Repair Cream 100g",
    handle: "dabo-all-in-one-black-snail-repair-cream-100g",
    subtitle: "100g",
    brand_handle: "dabo",
    origin_country: "KR",
    price_bdt: 1700,
  ...
  // ── KODOMO ──
  {
    title: "Kodomo Pink Hanabaki Baby Oil for 0+ kids 100ml",
    handle: "kodomo-pink-hanabaki-baby-oil-for-0-kids-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 613,
  ...
  {
    title: "Kodomo Oganiku Head To Toe Wash with Organic Oil 400ml",
    handle: "kodomo-oganiku-head-to-toe-wash-with-organic-oil-400ml",
    subtitle: "400ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 1600,
  ...
  {
    title: "Kodomo Baby Cream Pink Hanabaki 50g",
    handle: "kodomo-baby-cream-pink-hanabaki-50g",
    subtitle: "50g",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 1000,
  ...
  {
    title: "Kodomo Baby Soap Original with Moisturizer for 0+ Baby 75gm",
    handle: "kodomo-baby-soap-original-with-moisturizer-for-0-baby-75gm",
    subtitle: "75g",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 203,
  ...
  {
    title: "Kodomo Organic Aloe Vera Head-to-Toe Baby Shampoo 200ml",
    handle: "kodomo-organic-aloe-vera-head-to-toe-baby-shampoo-200ml",
    subtitle: "200ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 650,
  ...
  {
    title: "Kodomo Anti-Rash, Moisturizing & Hypoallergenic Baby Lotion 180ml",
    handle: "kodomo-anti-rash-moisturizing-and-hypoallergenic-baby-lotion-180ml",
    subtitle: "180ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 1400,
  ...
  {
    title: "Kodomo Pink Hanabaki Baby Lotion Powder 180ml",
    handle: "kodomo-pink-hanabaki-baby-lotion-powder-180ml",
    subtitle: "180ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 800,
  ...
  {
    title: "Kodomo Extra Mild Baby Lotion Powder for 0+ Baby 100ml",
    handle: "kodomo-extra-mild-baby-lotion-powder-for-0-baby-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 500,
  ...
  {
    title: "Kodomo Organic Aloe Vera Head-to-Toe Baby Shampoo – 100ml",
    handle: "kodomo-organic-aloe-vera-head-to-toe-baby-shampoo-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 560,
  ...
  {
    title: "Kodomo Organic Head-to-Toe Wash with Jojoba Oil – 100ml",
    handle: "kodomo-organic-head-to-toe-wash-with-jojoba-oil-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 560,
  ...
  {
    title: "Kodomo Hair & Body Wash Pink Hanabaki for 0+ Kids 100ml",
    handle: "kodomo-hair-and-body-wash-pink-hanabaki-for-0-kids-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 500,
  ...
  {
    title: "Kodomo Head to Toe Wash Mild Original for 0+ Kids 100ml",
    handle: "kodomo-head-to-toe-wash-mild-original-for-0-kids-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 340,
  ...
  {
    title: "Kodomo Baby Shampoo with Original Scent 100ml",
    handle: "kodomo-baby-shampoo-with-original-scent-100ml",
    subtitle: "100ml",
    brand_handle: "kodomo",
    origin_country: "TH",
    price_bdt: 470,
  ...
  // ── AXIS-Y ──
  {
    ...
    handle: "axis-y-dark-spot-correcting-glow-serum-5ml",
    subtitle: "5ml",
    brand_handle: "axis-y",
    origin_country: "KR",
    price_bdt: 450,
  ...
  // ── JOHNSON'S ──
  {
    title: "Johnson's Milk + Rice Hair & Body Baby Bath 200ml",
    handle: "johnson-s-milk-rice-hair-and-body-baby-bath-200ml",
    subtitle: "200ml",
    brand_handle: "johnsons",
    origin_country: "US",
    price_bdt: 790,
    sale_price_bdt: 700,
  },
  // ── COSRX ──
  {
    title: "COSRX AHA/BHA Clarifying Treatment Toner 50ml",
    handle: "cosrx-aha-bha-clarifying-treatment-toner-50ml",
    subtitle: "50ml",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 960,
  ...
  {
    title: "COSRX Vitamin E Vitalizing Sunscreen Broad Spectrum SPF 50+",
    handle: "cosrx-vitamin-e-vitalizing-sunscreen-broad-spectrum-spf-50",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 2500,
    sale_price_bdt: 1770,
  ...
  {
    title: "Cosrx Advanced Snail 92 All in One Cream 50g",
    handle: "cosrx-advanced-snail-92-all-in-one-cream-50g",
    subtitle: "50g",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 1450,
  ...
  {
    title: "Cosrx Hyaluronic Acid Intensive Cream 100gm",
    handle: "cosrx-hyaluronic-acid-intensive-cream-100gm",
    subtitle: "100g",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 2700,
  ...
  {
    title: "COSRX Low pH Niacinamide Micellar Cleansing Water 400ml",
    handle: "cosrx-low-ph-niacinamide-micellar-cleansing-water-400ml",
    subtitle: "400ml",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 4000,
  ...
  },
  {
    ...
    handle: "cosrx-low-ph-good-morning-gel-cleanser-50ml",
    subtitle: "50ml",
    brand_handle: "cosrx",
    origin_country: "KR",
    price_bdt: 850,
  ...
  // ── CETAPHIL ──
  {
    title: "Cetaphil Oily Skin Cleanser For Combination to Oily, Sensitive Skin 125ml",
    handle: "cetaphil-oily-skin-cleanser-for-combination-to-oily-sensitive-skin-125ml",
    subtitle: "125ml",
    brand_handle: "cetaphil",
    origin_country: "US",
    price_bdt: 1800,
  ...
  {
    title: "Cetaphil Bright Healthy Radiance Day Protection Cream SPF 15 50gm",
    handle: "cetaphil-bright-healthy-radiance-day-protection-cream-spf-15-50gm",
    subtitle: "50g",
    brand_handle: "cetaphil",
    origin_country: "US",
    price_bdt: 3000,
  ...
  {
    title: "Cetaphil Moisturising Cream for Dry To Normal, Sensitive Skin 80g",
    handle: "cetaphil-moisturising-cream-for-dry-to-normal-sensitive-skin-80g",
    subtitle: "80g",
    brand_handle: "cetaphil",
    origin_country: "US",
    price_bdt: 1550,
  ...
  // ── CATHY DOLL ──
  {
    title: "Cathy Doll Aura Whitening Serum Foam Cleanser 100ml",
    handle: "cathy-doll-aura-whitening-serum-foam-cleanser-100ml",
    subtitle: "100ml",
    brand_handle: "cathy-doll",
    origin_country: "TH",
    price_bdt: 650,
    sale_price_bdt: 415,
  },
  {
    title: "Cathy Doll Acne Solution Serum Foam Cleanser 100ml",
    handle: "cathy-doll-acne-solution-serum-foam-cleanser-100ml",
    subtitle: "100ml",
    brand_handle: "cathy-doll",
    origin_country: "TH",
    price_bdt: 850,
  ...
  // ── DR. ALVIN ──
  {
    title: "Dr. Alvin Kojic Acid Soap 135gm",
    handle: "dr-alvin-kojic-acid-soap-135gm",
    subtitle: "135g",
    brand_handle: "dr-alvin",
    origin_country: "PH",
    price_bdt: 750,
    sale_price_bdt: 425,
  },
  // ── DOT & KEY ──
  {
    title: "Dot & Key Cica Calming Blemish Clearing Gel Face Wash for Oily & Acne Prone Skin 100ml",
    handle: "dot-and-key-cica-calming-blemish-clearing-gel-face-wash-for-oily-and-acne-prone-skin-100ml",
    subtitle: "100ml",
    brand_handle: "dot-key",
    origin_country: "IN",
    price_bdt: 900,
    sale_price_bdt: 680,
  },
  // ── 3W CLINIC ──
  {
    title: "3W Clinic Intensive UV Sunblock Cream with SPF50+ PA+++ 70ml",
    handle: "3w-clinic-intensive-uv-sunblock-cream-with-spf50-pa-70ml",
    subtitle: "70ml",
    brand_handle: "3w-clinic",
    origin_country: "KR",
    price_bdt: 650,
    sale_price_bdt: 470,
  },
  // ── CHRISTIAN DEAN ──
  {
    title: "Christian Dean Secret Tone-Up Sun Cream SPF 50+ PA+++ 70ml",
    handle: "christian-dean-secret-tone-up-sun-cream-spf-50-pa-70ml",
    subtitle: "70ml",
    brand_handle: "christian-dean",
    origin_country: "KR",
    price_bdt: 650,
    sale_price_bdt: 430,
  },
  // ── K.BROTHERS ──
  {
    title: "K.Brothers Original Black Soap for Black Spot 50gm",
    handle: "k-brothers-original-black-soap-for-black-spot-50gm",
    subtitle: "50g",
    brand_handle: "k-brothers",
    origin_country: "TH",
    price_bdt: 225,
    sale_price_bdt: 175,
  },
  // ── FIORAE ──
  {
    title: "Fiorae Papaya & Gluta Plus Kojic Whitening Soap 165gm",
    handle: "fiorae-papaya-and-gluta-plus-kojic-whitening-soap-165gm",
    subtitle: "165g",
    brand_handle: "fiorae",
    origin_country: "TH",
    price_bdt: 620,
  ...
  // ── ARGEVILLE ──
  {
    title: "Argeville USA Beauty Care Face Out Soap For Black Spot Mask on Face",
    handle: "argeville-usa-beauty-care-face-out-soap-for-black-spot-mask-on-face",
    brand_handle: "argeville",
    origin_country: "TH",
    price_bdt: 450,
    sale_price_bdt: 335,
  },
  // ── KOJIE SAN ──
  {
    title: "Kojie San Skin Lightening Soap - Classic 135gm",
    handle: "kojie-san-skin-lightening-soap-classic-135gm",
    subtitle: "135g",
    brand_handle: "kojie-san",
    origin_country: "PH",
    price_bdt: 560,
    sale_price_bdt: 460,
  },
  // ── MOTHERCARE ──
  {
    title: "Mothercare All We Know Baby Cream (for 0+ Months) 100g",
    handle: "mothercare-all-we-know-baby-cream-for-0-months-100g",
    subtitle: "100g",
    brand_handle: "mothercare",
    origin_country: "GB",
    price_bdt: 1025,
    sale_price_bdt: 780,
  },
  {
    title: "Mothercare All We Know Baby Lotion 300ml",
    handle: "mothercare-all-we-know-baby-lotion-300ml",
    subtitle: "300ml",
    brand_handle: "mothercare",
    origin_country: "GB",
    price_bdt: 1000,
  ...
  // ── THE FACE SHOP ──
  {
    title: "The Face Shop Rice Water Bright Foaming Cleanser Nettoyant Moussant 150ml",
    handle: "the-face-shop-rice-water-bright-foaming-cleanser-nettoyant-moussant-150ml",
    subtitle: "150ml",
    brand_handle: "the-face-shop",
    origin_country: "KR",
    price_bdt: 1400,
  ...
  // ── SIMPLE ──
  {
    title: "Simple Kind to Skin Refreshing Facial Wash with Vitamin B5+E 150ml",
    handle: "simple-kind-to-skin-refreshing-facial-wash-with-vitamin-b5-e-150ml",
    subtitle: "150ml",
    brand_handle: "simple",
    origin_country: "GB",
    price_bdt: 800,
  ...
  // ── AVEENO ──
  {
    title: "Aveeno Baby Soothing Relief Emollient Cream 150ml",
    handle: "aveeno-baby-soothing-relief-emollient-cream-150ml",
    subtitle: "150ml",
    brand_handle: "aveeno",
    origin_country: "FR",
    price_bdt: 1850,
  ...
  {
    title: "Aveeno Baby Daily Care Moisturizing Lotion 150ml",
    handle: "aveeno-baby-daily-care-moisturizing-lotion-150ml",
    subtitle: "150ml",
    brand_handle: "aveeno",
    origin_country: "FR",
    price_bdt: 1400,
  ...
  // ── THANAKA ──
  {
    title: "Thanaka Face Pack (50g)",
    handle: "thanaka-face-pack-50g",
    subtitle: "50g",
    brand_handle: "thanaka",
    origin_country: "TH",
    price_bdt: 450,
    sale_price_bdt: 350,
  },
  {
    title: "Thanaka Face Pack (140g)",
    handle: "thanaka-face-pack-140g",
    subtitle: "140g",
    brand_handle: "thanaka",
    origin_country: "TH",
    price_bdt: 750,
  ...
  // ── ALIKE ──
  {
    title: "Alike 8K Plus 10X Whitening Night Cream 20g",
    handle: "alike-8k-plus-10x-whitening-night-cream-20g",
    subtitle: "20g",
    brand_handle: "alike",
    origin_country: "TH",
    price_bdt: 995,
  ...
  // ── WHITE AURA ──
  {
    title: "White Aura Miracle Carrot Soap 160gm",
    handle: "white-aura-miracle-carrot-soap-160gm",
    subtitle: "160g",
    brand_handle: "white-aura",
    origin_country: "TH",
    price_bdt: 650,
    sale_price_bdt: 590,
  },
  // ── FAIRY ──
  {
    title: "Fairy Coffee Green Tea & Coconut Oil Gluta Brightening Scrub Soap 60g",
    handle: "fairy-coffee-green-tea-and-coconut-oil-gluta-brightening-scrub-soap-60g",
    subtitle: "60g",
    brand_handle: "fairy",
    origin_country: "GB",
    price_bdt: 450,
