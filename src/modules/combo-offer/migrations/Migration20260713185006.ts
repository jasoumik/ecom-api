...
export class Migration20260713185006 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "combo_offer" ("id" text not null, "name" text not null, "slug" text not null, "description" text null, "image" text null, "originalPrice" integer not null, "comboPrice" integer not null, "isActive" boolean not null default true, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "combo_offer_pkey" primary key ("id"));`);
